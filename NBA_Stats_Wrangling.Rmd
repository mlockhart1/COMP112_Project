...
```{r}
drft_num <- all_seasons %>% 
  group_by(player_name) %>% 
  select(country, draft_number) 
  
```

How to get distinct players without loosing other data (country, draft_number)?
```{r}
drft_num %>% 
  full_join(dist_players, by="player_name" )  
```
